...
struct Camera {
    Vec3 eye,look,up; double vfov; int W,H;
    Vec3 u,v,w; double aspect, halfH, halfW;
    ...
    Ray primary(double sx,double sy) const{ Vec3 dir = normalize(-w + sx*halfW*u + sy*halfH*v); return Ray(eye, dir); }
};
} // namespace rt
